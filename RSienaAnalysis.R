...
MyData <- sienaDataCreate(allInteractions, cluster0, cluster1, cluster2, cluster3, logged_edits, activeDays, complex_total,local_talk_total, daysSinceJoining)
...
MyEffects <- includeEffects(MyEffects,simX, interaction1="cluster1", name="allInteractions")

MyEffects <- includeEffects(MyEffects, name = "cluster1", avAlt, interaction1 = "allInteractions")
#MyEffects <- includeEffects(MyEffects, name = "cluster2", avAlt, interaction1 = "allInteractions")
#MyEffects <- includeEffects(MyEffects, name = "cluster0", avAlt, interaction1 = "allInteractions")

# Covar effects
#MyEffects <- includeEffects(MyEffects,egoX,simX, interaction1 = "logged_edits", name="allInteractions")

MyEffects <- includeEffects(MyEffects,simX, egoXaltX, interaction1 = "daysSinceJoining", name="allInteractions")

#MyEffects <- includeEffects(MyEffects,simX, interaction1 = "loggedActivity", name="allInteractions")
#MyEffects <- includeEffects(MyEffects,egoX,simX, interaction1 = "complex_total", name="allInteractions")
#MyEffects <- includeEffects(MyEffects,simX, interaction1 = "complexActivity", name="allInteractions")
#MyEffects <- includeEffects(MyEffects,simX, interaction1 = "communityTalkActivity", name="allInteractions")
#MyEffects <- includeEffects(MyEffects,simX, interaction1 = "communityTalkActivity", name="allInteractions")
#MyEffects <- includeEffects(MyEffects,simX, interaction1 = "localTalkActivity", name="allInteractions")
#MyEffects <- includeEffects(MyEffects,simX, interaction1 = "localTalkActivity", name="allInteractions")
#MyEffects <- includeEffects(MyEffects, RateX, type="rate", interaction1="logged_edits", name="allInteractions")
#MyEffects <- includeEffects(MyEffects, RateX, type="rate", interaction1="daysSinceJoining", name="allInteractions")
#MyEffects <- includeEffects(MyEffects, RateX, type="rate", interaction1="loggedActivity", name="allInteractions")
#MyEffects <- includeEffects(MyEffects, RateX, type="rate", interaction1="activityBeh", name="allInteractions")
#MyEffects <- includeEffects(MyEffects, RateX, type="rate", interaction1="activityBeh", name="allInteractions")
#MyEffects <- includeEffects(MyEffects,simX, interaction1 = "communityActivity", name="allInteractions")
#MyEffects <- includeEffects(MyEffects,simX, interaction1 = "communityTalkActivity", name="allInteractions")
#MyEffects <- includeEffects(MyEffects,simX, interaction1 = "localTalkActivity", name="allInteractions")
# Effects on behavior
...
#MyEffects <- includeTimeDummy(MyEffects, density, name="allInteractions", timeDummy = "4")
#MyEffects <- includeTimeDummy(MyEffects, reciprocity, name="allInteractions", timeDummy = "7")
...
MyModel <-sienaModelCreate(projname = "allInteractionsTest")
MyResults <- siena07(MyModel, data=MyData, effects=MyEffects,batch=FALSE)

siena.table(MyResults, type="latex", file="allInteractionsResults.tex", sig=TRUE)
