...
MyEffects <- includeEffects(MyEffects,simX, interaction1="cluster1", name="allInteractions","creation")
...
#MyEffects <- includeEffects(MyEffects,simX, interaction1 = "daysSinceJoining", name="allInteractions")
