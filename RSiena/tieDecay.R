...
centralRole <- makeVarCovar(clust1)
periphExpertRole <- makeVarCovar(clust2)
newbieRole <- makeVarCovar(clust3)

MyData <- sienaDataCreate(observation, lowActivityRole, centralRole, periphExpertRole, newbieRole, logged_edits, activeDays, complex_total,local_talk_total, daysSinceJoining, eigenvectorCentrality)

MyEffects <- getEffects(MyData)

print01Report(MyData, MyEffects, modelname="observationTieDecayWithInteractions")

# Include network effects
#MyEffects <- includeEffects(MyEffects,transTrip, balance, name="observation")
...
MyEffects <- includeEffects(MyEffects,simX, interaction1="lowActivityRole", name="observation",type="endow")
##MyEffects <- includeEffects(MyEffects,simX, interaction1="lowActivityRole", name="observation",type="creation")
MyEffects <- includeEffects(MyEffects,simX, interaction1="centralRole", name="observation",type="endow")
##MyEffects <- includeEffects(MyEffects,simX, interaction1="centralRole", name="observation",type="creation")
MyEffects <- includeEffects(MyEffects,simX, interaction1="periphExpertRole", name="observation",type="endow")
##MyEffects <- includeEffects(MyEffects,simX, interaction1="periphExpertRole", name="observation",type="creation")
MyEffects <- includeEffects(MyEffects,simX, interaction1="newbieRole", name="observation",type="endow")
#MyEffects <- includeEffects(MyEffects,simX, interaction1="newbieRole", name="observation",type="creation")
...
#MyEffects <- includeEffects(MyEffects,effFrom, interaction1 = "eigenvectorCentrality", name="centralRole")
...
MyEffects <- includeInteraction(MyEffects, egoX, altX, name="observation", interaction1=c("newbieRole","centralRole"), type="endow")
MyEffects <- includeInteraction(MyEffects, egoX, altX, name="observation", interaction1=c("lowActivityRole","centralRole"), type="endow")
MyEffects <- includeInteraction(MyEffects, egoX, altX, name="observation", interaction1=c("periphExpertRole","centralRole"), type="endow")
MyEffects <- includeInteraction(MyEffects, egoX, altX, name="observation", interaction1=c("newbieRole","periphExpertRole"), type="endow")
MyEffects <- includeInteraction(MyEffects, egoX, altX, name="observation", interaction1=c("lowActivityRole","periphExpertRole"), type="endow")

#MyEffects <- includeEffects(MyEffects,X,name="observation",interaction1="localCom")
MyModel <-sienaModelCreate(projname = "observationTieDecay")
MyResults <- siena07(MyModel, data=MyData, effects=MyEffects,batch=FALSE)

siena.table(MyResults, type="latex", file="observationTieDecayWithInteractionsResults.tex", sig=TRUE)
