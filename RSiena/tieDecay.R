...
wd <-"~/Programming/WeRelate/DataFiles/ThesisNetworks"
...
# Load files
filesToImport <- dir(wd, pattern="2*.csv")
...
print01Report(MyData, MyEffects, modelname="allInteractionsTieDecayWithInteractions")
